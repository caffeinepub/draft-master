...
export const DraftData = IDL.Record({
  'content' : IDL.Text,
  'owner' : IDL.Principal,
...
export const idlService = IDL.Service({
  ...
  'generateShareLink' : IDL.Func([IDL.Text], [IDL.Text], []),
  'getAllRSVPs' : IDL.Func([], [IDL.Vec(RSVP)], ['query']),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getDraftByShareLink' : IDL.Func([IDL.Text], [IDL.Opt(DraftData)], ['query']),
